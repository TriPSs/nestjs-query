---
title: "DTOs"
description: "Throughout the documentation you will read about DTOs (Data Transfer Object). If you have never heard of a DTO before you can read about them"
---
...
## Why are DTOs separate from the database entity definition?[​](#why-are-dtos-separate-from-the-database-entity-definition "Direct link to Why are DTOs separate from the database entity definition?")
...
[Edit this page](https://github.com/tripss/nestjs-query/edit/master/docs/concepts/dtos)
