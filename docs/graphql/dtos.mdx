...
By default, GraphQL offset and cursor queries allow at most `100` records per page. Use `maxResultsSize` to override this maximum. CSV exports use their own `limit` option.
