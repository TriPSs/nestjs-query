---
title: 'Hooks'
description: 'provides the following hooks that allow you to modify incoming requests.'
---
...
<Warning>The graphql context by default only contains the incoming request!</Warning>

<Note>If you provide a custom `create` or `update` DTO you can also decorate those classes with corresponding decorators.</Note>
...
## @BeforeCreateOne[​](#beforecreateone 'Direct link to @BeforeCreateOne')
...
### Hook Function[​](#hook-function 'Direct link to Hook Function')
...
### Hook Class[​](#hook-class 'Direct link to Hook Class')
...
## @BeforeCreateMany[​](#beforecreatemany 'Direct link to @BeforeCreateMany')
...
### Hook Function[​](#hook-function-1 'Direct link to Hook Function')
...
### Hook Class[​](#hook-class-1 'Direct link to Hook Class')
...
## @BeforeUpdateOne[​](#beforeupdateone 'Direct link to @BeforeUpdateOne')
...
### Hook Fnction[​](#hook-fnction 'Direct link to Hook Fnction')
...
### Hook Class[​](#hook-class-2 'Direct link to Hook Class')
...
## @BeforeUpdateMany[​](#beforeupdatemany 'Direct link to @BeforeUpdateMany')
...
### Hook Function[​](#hook-function-2 'Direct link to Hook Function')
...
### Hook Class[​](#hook-class-3 'Direct link to Hook Class')
...
## Using Hooks In Custom Endpoints[​](#using-hooks-in-custom-endpoints 'Direct link to Using Hooks In Custom Endpoints')
...
<Warning>When using the HookInterceptor you must use the DTO that you added the hook decorator to.</Warning>

<Note>
  In this example we bind the `BEFORE_UPDATE_MANY` hook, you can use any of the hooks available to bind to the correct one when
...
[Edit this page](https://github.com/tripss/nestjs-query/edit/master/docs/graphql/hooks)
