...
<Info>
  If you are extending the `CRUDResolver` directly be sure to [register your DTOs with the `NestjsQueryGraphQLModule`](/graphql/resolvers#crudresolver)
</Info>
...
[Edit this page](https://github.com/tripss/nestjs-query/edit/master/docs/graphql/authorization)
