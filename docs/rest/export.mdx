---
title: 'CSV Export'
description: 'Every  includes a CSV endpoint at . It supports the same generated filters, search hook, authorization filter, default sorting, and soft-delete visibility options as collection reads.'
---
