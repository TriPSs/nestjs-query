...
CSV exports serialize `Date` values as UTC ISO 8601 strings (for example, `2026-09-20T12:30:00.000Z`). Use an export DTO `@Transform()` to return a string for a different format.
