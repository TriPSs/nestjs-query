---
title: 'Hooks'
description: 'Hooks transform generated endpoint arguments before the query service is called. REST currently exposes BeforeCreateOne, BeforeUpdateOne, and BeforeQueryMany hooks. A hook can be an inline function or an injectable class.'
---
