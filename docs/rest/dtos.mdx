---
title: 'DTOs'
description: 'REST DTOs describe response serialization, request validation, OpenAPI schemas, identifiers, and the fields accepted as filters. Their decorators combine metadata from class-transformer, class-validator, and @nestjs/swagger.'
---
