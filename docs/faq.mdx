...
- If you have fields that should be computed or derived from your entity try using an [Assembler](./concepts/advanced/assemblers)
...
<Note>
  When combining your entity and DTO you should **NOT** decorate your relationships with `@Field` or `@FilterableField`. Instead,
  add them to your CRUDResolver. [Read More](./persistence/services#relations)
</Note>
...
- [DTO Paging Strategy](./graphql/dtos#paging-strategy)
...
- [`@FilterableRelation`](./graphql/relations#filterablerelation)
- [`@FilterableConnection`](./graphql/relations#filterableoffsetconnection)
