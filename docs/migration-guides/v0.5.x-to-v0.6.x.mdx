...
### `@InjectTypeOrmQueryService`[​](#injecttypeormqueryservice "Direct link to injecttypeormqueryservice")
...
## `TypeOrmQueryService`[​](#typeormqueryservice "Direct link to typeormqueryservice")
...
## `AssemblerQueryService`[​](#assemblerqueryservice "Direct link to assemblerqueryservice")
...
[Edit this page](https://github.com/tripss/nestjs-query/edit/master/docs/migration-guides/v0.5.x-to-v0.6.x)
