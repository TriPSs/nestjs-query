...
## Offset Paging Strategy \[BREAKING CHANGE][​](#offset-paging-strategy-breaking-change "Direct link to Offset Paging Strategy \[BREAKING CHANGE]")
...
## Total Count with OFFSET Strategy[​](#total-count-with-offset-strategy "Direct link to Total Count with OFFSET Strategy")
...
## Relation Decorator Changes \[BREAKING CHANGE][​](#relation-decorator-changes-breaking-change "Direct link to Relation Decorator Changes \[BREAKING CHANGE]")
...
## Hook Updates[​](#hook-updates "Direct link to Hook Updates")
...
## Registering DTOs When Using Custom Resolvers[​](#registering-dtos-when-using-custom-resolvers "Direct link to Registering DTOs When Using Custom Resolvers")
...
In the latest version you now have the option to register your DTOs with `@ptc-org/nestjs-query-graphql` without it generating a resolver automatically.
...
[Edit this page](https://github.com/tripss/nestjs-query/edit/master/docs/migration-guides/v0.22.x-to-v0.23.x)
