...
If you implement `QueryService` directly rather than extending a provided service, add a `nullOrdering` member. Return `undefined` to keep the previous behaviour.
