...
<Note>There are multiple ways to set of references in Typegoose. These are intended as a starting point.</Note>

<Warning>Filtering on references is not supported by Typegoose.</Warning>
