...
`nestjs-query` is a TypeScript monorepo for NestJS query libraries. It uses Yarn 4 workspaces and Nx. Reusable libraries live in `packages/`; runnable and end-to-end examples live in `examples/`; the documentation site lives in `documentation/`.
...
- Update documentation for user-facing features. New documentation pages must also be added to `documentation/sidebars.js`.
