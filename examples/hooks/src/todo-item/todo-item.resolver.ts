import { InjectQueryService, mergeFilter, QueryService, UpdateManyResponse } from '@rezonapp/nestjs-query-core';
import { HookTypes, HookInterceptor, MutationHookArgs, UpdateManyResponseType } from '@rezonapp/nestjs-query-graphql';
