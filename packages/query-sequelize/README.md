...
[![npm version](https://img.shields.io/npm/v/@souagrosolucoes/nestjs-query-sequelize.svg)](https://www.npmjs.org/package/@souagrosolucoes/nestjs-query-sequelize)
...
The `query-sequelize` package that provides an implementation of `@souagrosolucoes/nestjs-query-core` `QueryService`, built on
...
The get started with the `@souagrosolucoes/nestjs-query-sequelize` package checkout
