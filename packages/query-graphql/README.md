...
This package provides a code-first implementation of GraphQL CRUD endpoints built on [NestJS](https://nestjs.com/).
...
To get started with `@ptc-org/nestjs-query-graphql`, check out the [Getting Started](https://nestjs-query.mintlify.site/graphql/getting-started) guide.
