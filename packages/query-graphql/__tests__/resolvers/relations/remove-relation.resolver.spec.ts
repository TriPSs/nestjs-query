...
interface FinalizedTestResolver {
	removeRelationFromTestResolverDTO(options: { input: RelationInputType }): any;

	removeCustomFromTestResolverDTO(options: { input: RelationInputType }): any;

	removeRelationsFromTestResolverDTO(options: { input: RelationsInputType }): any;

	removeCustomsFromTestResolverDTO(options: { input: RelationsInputType }): any;
}
