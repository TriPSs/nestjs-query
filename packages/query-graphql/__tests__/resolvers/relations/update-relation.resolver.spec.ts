...
interface FinalizedTestResolver {
	setRelationOnTestResolverDTO(options: { input: RelationInputType }): any;

	setCustomOnTestResolverDTO(options: { input: RelationInputType }): any;

	addRelationsToTestResolverDTO(options: { input: RelationsInputType }): any;

	addCustomsToTestResolverDTO(options: { input: RelationsInputType }): any;

	setRelationsOnTestResolverDTO(options: { input: RelationsInputType }): any;

	setCustomsOnTestResolverDTO(options: { input: RelationsInputType }): any;
}
