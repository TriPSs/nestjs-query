...
describe('ReadRelationsResolver - pivot - 4', () => {
  it('should add the properties to the filter when enableFilter is set', () =>
    expectResolverSDL({ many: { relations: { DTO: TestRelationDTO, pivot: { ...pivot, enableFilter: true } } } }))
})
