import { ArrayReflector, Class, FilterComparisonOperators, getPrototypeChain } from '@tripss/nestjs-query-core';
 ...
 *
 * ```ts
 * import { FilterableField } from '@tripss/nestjs-query-graphql';
