...
describe('SQLComparisonBuilder', (): void => {
  ...
  describe('#deriveForEntityMetadata', () => {
    ...
    it('should carry the state of a subclass that does not override it', (): void => {
      class SuffixedComparisonBuilder<Entity> extends SQLComparisonBuilder<Entity> {
      ...
      const derived = new SuffixedComparisonBuilder<TestEntity>().deriveForEntityMetadata<TestEntity>(plainColumnMetadata)
