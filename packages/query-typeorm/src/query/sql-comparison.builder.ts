...
export class SQLComparisonBuilder<Entity> {
   ...
   *
   * @param entityMetadata - metadata of the entity the derived builder builds comparisons for, or
   * `undefined` when a relation was supplied without its metadata, in which case no virtual columns
   * are expanded for it.
   */
