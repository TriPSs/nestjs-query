...
export class WhereBuilder<Entity> {
   ...
   *
   * @param entityMetadata - metadata of the entity the derived builder builds WHERE clauses for, or
   * `undefined` when a relation was supplied without its metadata.
   */
  public deriveForEntityMetadata<Relation>(entityMetadata: EntityMetadata | undefined): WhereBuilder<Relation> {
