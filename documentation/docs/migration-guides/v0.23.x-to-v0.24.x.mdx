...
```ts
import { ConnectionType, SortType } from '@souagrosolucoes/nestjs-query-graphql';
...
import { FilterableField, QueryOptions, PagingStrategies } from '@souagrosolucoes/nestjs-query-graphql';
