...
`@souagrosolucoes/nestjs-query-graphql` provides a number of types. Most will be automatically generated for you when you create a
...
```ts
import { DeleteManyResponseType } from '@souagrosolucoes/nestjs-query-graphql';
...
GraphQL implementation of the `@souagrosolucoes/nestjs-query-core` `Filter` type.
...
```ts
import { FilterType } from '@souagrosolucoes/nestjs-query-graphql';
import { TodoItemDTO } from './dto/todo-item.dto';
...
For more comprehensive examples take a look at the [Sorting Docs](./queries/sorting)
...
```ts
import { UpdateOneInputType } from '@souagrosolucoes/nestjs-query-graphql';
import { InputType } from '@nestjs/graphql';
import { TodoItemDTO } from './dto/todo-item.dto';
...
```ts
import { CreateOneInputType, FilterType } from '@souagrosolucoes/nestjs-query-graphql';
import { InputType } from '@nestjs/graphql';
import { TodoItemDTO } from './dto/todo-item.dto';
...
```ts
import { DeleteOneInputType } from '@souagrosolucoes/nestjs-query-graphql';
import { InputType } from '@nestjs/graphql';
import { TodoItemDTO } from './dto/todo-item.dto';
