...
`@souagrosolucoes/nestjs-query-graphql` will then automatically create the following graphql definition:
...
```ts title="sub-task/sub-task.dto.ts" {6}
import { FilterableField, IDField, FilterableRelation } from '@souagrosolucoes/nestjs-query-graphql';
import { ObjectType, ID, GraphQLISODateTime } from '@nestjs/graphql';
import { TodoItemDTO } from '../todo-item/todo-item.dto.ts';
...
import { FilterableField, IDField, UnPagedRelation } from '@souagrosolucoes/nestjs-query-graphql';
import { ObjectType, ID, GraphQLISODateTime } from '@nestjs/graphql';
...
```ts title="sub-task/sub-task.dto.ts" {6}
import { FilterableField, IDField, FilterableUnPagedRelation } from '@souagrosolucoes/nestjs-query-graphql';
import { ObjectType, ID, GraphQLISODateTime } from '@nestjs/graphql';
import { SubTaskDTO } from '../sub-task/sub-task.dto'
...
```ts title="todo-item/todo-item.dto.ts" {6}
import { FilterableField, IDField, OffsetConnection } from '@souagrosolucoes/nestjs-query-graphql';
import { ObjectType, ID, GraphQLISODateTime } from '@nestjs/graphql';
import { SubTaskDTO } from '../sub-task/sub-task.dto'
...
import { FilterableField, IDField, FilterableOffsetConnection, QueryOptions } from '@souagrosolucoes/nestjs-query-graphql';
import { ObjectType, ID, GraphQLISODateTime } from '@nestjs/graphql';
import { SubTaskDTO } from '../sub-task/sub-task.dto'
...
```ts title="todo-item/todo-item.module.ts"
import { PagingStrategies } from '@souagrosolucoes/nestjs-query-core';
import { NestjsQueryGraphQLModule } from '@souagrosolucoes/nestjs-query-graphql';
import { NestjsQueryTypeOrmModule } from '@souagrosolucoes/nestjs-query-typeorm';
import { Module } from '@nestjs/common';
import { TodoItemDTO } from './todo-item.dto';
...
```ts title="todo-item/todo-item.dto.ts" {6}
import { FilterableField, IDField, CursorConnection } from '@souagrosolucoes/nestjs-query-graphql';
import { ObjectType, ID, GraphQLISODateTime } from '@nestjs/graphql';
import { SubTaskDTO } from '../sub-task/sub-task.dto'
...
```ts title="todo-item/todo-item.dto.ts" {6}
import { FilterableField, IDField, Connection } from '@souagrosolucoes/nestjs-query-graphql';
import { ObjectType, ID, GraphQLISODateTime } from '@nestjs/graphql';
import { SubTaskDTO } from '../sub-task/sub-task.dto'
...
```ts title="todo-item/todo-item.dto.ts" {6}
import { FilterableField, IDField, FilterableCursorConnection } from '@souagrosolucoes/nestjs-query-graphql';
import { ObjectType, ID, GraphQLISODateTime } from '@nestjs/graphql';
import { SubTaskDTO } from '../sub-task/sub-task.dto'
...
import { ReadResolver, Relatable } from '@souagrosolucoes/nestjs-query-graphql';
