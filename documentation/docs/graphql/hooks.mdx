...
```ts {7-10}
import { FilterableField, BeforeCreateOne, CreateOneInputType } from '@souagrosolucoes/nestjs-query-graphql';
...
import { BeforeCreateOneHook, CreateOneInputType,} from '@souagrosolucoes/nestjs-query-graphql';
...
```ts {6}
import { FilterableField, BeforeCreateOne } from '@souagrosolucoes/nestjs-query-graphql';
import { ObjectType, ID, GraphQLISODateTime, Field } from '@nestjs/graphql';
...
```ts {7-11}
import { FilterableField, BeforeCreateMany, CreateManyInputType } from '@souagrosolucoes/nestjs-query-graphql';
import { ObjectType, ID, GraphQLISODateTime, Field } from '@nestjs/graphql';
import { GqlContext } from '../../interfaces';
import { getUserName } from '../../helpers';
...
```ts
import { Injectable } from '@nestjs/common';
import { BeforeCreateManyHook, CreateManyInputType,} from '@souagrosolucoes/nestjs-query-graphql';
import { GqlContext } from './auth/auth.guard';
import { AuthService } from './auth/auth.service';
...
```ts {6}
import { FilterableField, BeforeCreateMany } from '@souagrosolucoes/nestjs-query-graphql';
import { ObjectType, ID, GraphQLISODateTime, Field } from '@nestjs/graphql';
import { CreatedByHook } from '../../hooks';
...
```ts {7-10}
import { FilterableField, BeforeUpdateOne, UpdateOneInputType } from '@souagrosolucoes/nestjs-query-graphql';
...
```ts
import { BeforeUpdateOneHook, UpdateOneInputType } from '@souagrosolucoes/nestjs-query-graphql';
import { Injectable } from '@nestjs/common';
import { GqlContext } from './auth/auth.guard';
import { AuthService } from './auth/auth.service';
...
```ts {6}
import { FilterableField, BeforeUpdateOne } from '@souagrosolucoes/nestjs-query-graphql';
import { ObjectType, ID, GraphQLISODateTime, Field } from '@nestjs/graphql';
import { CreatedByHook } from '../../hooks';
...
```ts {7-10}
import { FilterableField, BeforeUpdateMany, UpdateManyInputType } from '@souagrosolucoes/nestjs-query-graphql';
import { ObjectType } from '@nestjs/graphql';
import { GqlContext } from '../../interfaces';
import { getUserName } from '../../helpers';
...
In this example we create a simple Hook that works with any type that has a `updatedBy` property.
```ts
import { BeforeUpdateManyHook, UpdateManyInputType } from '@souagrosolucoes/nestjs-query-graphql';
import { Injectable } from '@nestjs/common';
import { GqlContext } from './auth/auth.guard';
import { AuthService } from './auth/auth.service';
...
```ts {6}
import { FilterableField, BeforeUpdateMany } from '@souagrosolucoes/nestjs-query-graphql';
import { ObjectType, ID, GraphQLISODateTime, Field } from '@nestjs/graphql';
import { CreatedByHook } from '../../hooks';
...
import { HookTypes, HookInterceptor, MutationHookArgs, UpdateManyResponseType } from '@souagrosolucoes/nestjs-query-graphql';
