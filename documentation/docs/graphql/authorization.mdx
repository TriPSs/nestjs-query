...
The `@souagrosolucoes/nestjs-query-graphql` package includes an `@Authorize` decorator that allows you to add additional filter
...
import { FilterableField, IDField, FilterableRelation, Authorize } from '@souagrosolucoes/nestjs-query-graphql';
...
import { Authorize, FilterableField, IDField, FilterableRelation } from '@souagrosolucoes/nestjs-query-graphql';
import { ObjectType, ID, GraphQLISODateTime } from '@nestjs/graphql';
import { TodoItemDTO } from '../../todo-item/dto/todo-item.dto';
import { UserDTO } from '../../user/user.dto';
...
import { Filter, InjectQueryService, mergeFilter, mergeQuery, QueryService } from '@souagrosolucoes/nestjs-query-core';
import { AuthorizerInterceptor, AuthorizerFilter, ConnectionType } from '@souagrosolucoes/nestjs-query-graphql';
...
import { CRUDResolver, InjectAuthorizer } from '@souagrosolucoes/nestjs-query-graphql';
...
```ts title='sub-task/sub-task.authorizer.ts'
import { Injectable } from '@nestjs/common';
import { CustomAuthorizer } from '@souagrosolucoes/nestjs-query-graphql';
import { Filter } from '@souagrosolucoes/nestjs-query-core';
import { UserContext } from '../auth/auth.interfaces';
import { SubTaskDTO } from './dto/sub-task.dto';
